...
private:
	...
	bool StartWith(std::string& line, const std::string text);
	void AddVertexData(int vIdx, int nIdx, const std::string mtl, std::vector<Position>& vertices, std::vector<Normal>& normals);
...
static std::vector<Vertex> objLoader(const char* file_name)
{
	//Vertex portions
